...
public:
	UPROPERTY(Category = "POS_Quest", VisibleAnywhere, BlueprintReadWrite)
...
protected:
	...
	UPROPERTY(Category = "POS_Widget", VisibleAnywhere, BlueprintReadWrite)
	TObjectPtr<UPOSQuestMainPanelWidget> QuestMainPanelWidget;

	void NativeConstruct() override;
private:
	UFUNCTION(Category = "POS_Widget")
